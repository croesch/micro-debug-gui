...
public final class MacroLineBreakpointHandler extends ALineBreakpointHandler {
   ...
   */
  public MacroLineBreakpointHandler(final BreakpointManager bpm) {
    super(bpm);
  }
  ...
  public boolean isBreakpoint(final int line) {
    return getBreakpointManager().isMacroBreakpoint(Integer.valueOf(line));
  }

  @Override
  protected void addBreakpoint(final int line) {
    getBreakpointManager().addMacroBreakpoint(Integer.valueOf(line));
  }

  @Override
  protected void removeBreakpoint(final int line) {
    getBreakpointManager().removeMacroBreakpoint(Integer.valueOf(line));
  }
}
